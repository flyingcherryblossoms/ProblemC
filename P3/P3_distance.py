...
for i in range(len(taskName)):
    ...
    writeToExcel('P3_taskLists'+str(i+1), taskList)
...
for k in range(len(taskLists)):
    ...
    print(taskPoint)
    writeToExcel("P3_taskPoint"+str(k+1), taskPoint)
...
for k in range(len(taskLists)):
    ...
    writeToExcel('P3_distance' + str(k+1), distance)
...
for k in range(len(taskLists)):
    writeToExcel("P3_distance" + str(k+1), distances[k])
